    ...
    <footer className="w-full">
            ...
            <div className="col-span-1 lg:col-span-2 space-y-6">
              ...
              <div className="flex flex-col gap-3 pt-2 lg:flex-row lg:flex-wrap lg:items-center lg:gap-6">
                ...
                <div className="flex items-center gap-3 text-sm text-gray-100">
                  ...
                  <span>Tel: {footerData?.support_center || "+971 42 88 1400"}</span>
                </div>
                <div className="flex items-center gap-3 text-sm text-gray-100">
      ...
      {footerData?.cell && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-6 right-6 z-50 flex items-center justify-center bg-[#25D366] hover:bg-[#20bd5a] text-white p-3 md:p-4 rounded-full shadow-lg transition-all duration-300 group overflow-hidden"
