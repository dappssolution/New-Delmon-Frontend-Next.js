          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid sm:grid-cols-3 gap-4 items-center">
                ...
                <label className="sm:col-span-2 flex items-center w-full px-4 py-2.5 border border-green-700 rounded-lg bg-white text-gray-700 cursor-pointer">
                  <span className="px-3 py-1 bg-gray-200 rounded text-xs mr-3">
                    Choose file
                  </span>
                  {selectedPhoto?.name || "No chosen file"}
